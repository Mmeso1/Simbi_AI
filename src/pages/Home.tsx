        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-4 space-x-2">
              <button onClick={() => router.push('/Signup')} className="bg-[#6046FF] text-white px-4 py-2 rounded-md text-sm">Get Started</button>
              <button onClick={() => router.push('/Signin')} className="text-sm border px-4 py-2 rounded-md">I Have an Account</button>
            </div>
          </div>
        </div>
      </section>
