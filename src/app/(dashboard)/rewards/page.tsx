...
import HeaderSearch from '@/components/dashboard/HeaderNotification'
import HeaderNotification from '@/components/dashboard/HeaderSearch'
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
      ...
      <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center text-center">
        <div className="flex items-center space-x-2 mb-4">
          <span className="text-yellow-500 text-2xl"><img src="DashboardIcons/coins.png" alt="" /></span>
          <h2 className="text-lg font-semibold">Total Tokens Earned</h2>
        </div>
        <Image src="/DashboardIcons/bigg.png" alt="Token" width={80} height={80} className="mb-4" />
      ...
      <div className="bg-white rounded-xl shadow p-6 flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-yellow-500 text-xl"><img src="DashboardIcons/star-03.png" alt="" /></span>
          ...
          <div className="flex space-x-4 mt-4">
            {["gold", "silver"].map((badge) => (
              <div key={badge} className="flex flex-col items-center">
                ...
                <p className="text-xs font-semibold mt-1 capitalize">{badge}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {[
        ...
        <div key={idx} className="bg-white rounded-xl shadow p-5">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <Image src="/DashboardIcons/small.png" alt="token" width={20} height={20} className='mr-28'/>
            {item.progress && <p className="text-sm font-medium">{item.progress}</p>}
            {!item.progress && (
