    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#b194f7] to-[#f7c59f] rounded-[30px] overflow-hidden p-4">
      ...
      <div className="text-center z-10 max-w-md">
        ...
        <p className="text-sm text-gray-800 mt-2 leading-relaxed">
          Transform every study milestone into value.
          <br />
          Earn <strong>$SIMBI tokens</strong>, unlock exclusive NFT badges by
          crushing quizzes, connect your wallet and swap your study wins for
          cool prizes.
        </p>
        <Link href="https://t.me/simbi_ai_bot" target="_blank">
