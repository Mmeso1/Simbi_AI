...
export default function Home() {
  ...
  return (
    <main className="bg-[#FDFDFF] text-[#1E1E2F">
      ...
      <section className="hidden lg:flex flex-col justify-center bg-[#E9E8FF] h-[78vh] text-center">
        <div className="flex flex-row justify-center items-center gap-24">
          ...
          <div className="flex flex-col justify-center mb-6">
            ...
            <div className="mt-14 flex flex-row md:flex-col justify-center items-center">
              {!isLoggedIn ? (
                <>
      ...
      {/* Hero Section */}
      {/* Tablet & Mobile-Only View */}
      <section className="lg:hidden flex flex-col items-center justify-between bg-[#E9E8FF] min-h-[100vh] px-6 pt-16 pb-10 text-center">
        <div className="max-w-md w-full">
          ...
          <p className="mt-4 text-base text-[#6B7280] leading-relaxed">
            Simbi helps you plan, stay motivated and learn
            <br />
        ...
        <div className="bg-white rounded-xl shadow-lg max-w-xl py-8 px-6">
          ...
          <div className="flex items-center gap-6 mt-4">
            <p className="text-base md:text-lg text-gray-700">
              You missed your flashcards again? Your <br /> neurons are
              screaming for mercy. Open the <br /> app before I start erasing
              your GPA.
            </p>
            <Image
              src="/images/simbi-3.svg"
        ...
        <div className="mt-30">
          ...
          <div className="mt-18 space-x-2 mx-auto">
            <Link href="/auth/signup" className="">
              <button className="bg-[#7A5FFF] text-white px-14 py-3 rounded-1 text-sm">
                Get Started
              </button>
            </Link>
            <Link href="/auth/signin">
              <button className="text-sm text-[#7A5FFF] border border-[#7A5FFF] px-14 py-3 rounded-1">
                I Have an Account
              </button>
            </Link>
          </div>
