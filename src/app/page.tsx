...
export default function Home() {
  return (
    <main className="bg-[#FDFDFF] text-[#1E1E2F]">
      ...
      {/* Hero Section */}
      <section className="flex flex-col justify-center bg-[#E9E8FF] min-h-[80vh] text-center px-6 md:px-16">
      ...
      {/* Why Simbi Works */}
      <section className="bg-[#E4DFFF] py-20 px-6 md:px-16 text-center">
      ...
      {/* Real talk */}
      <section className="flex flex-col lg:flex-row justify-center items-center px-6 py-20 gap-10">
        ...
        <div className="bg-white rounded-xl shadow-lg max-w-xl py-8 px-6">
          ...
          <p className={`mt-4 font-black text-xl ${roboto.className}`}>Simbi, <span className="font-normal text-sm">your best frenemy!</span></p>
        </div>
      </section>
      ...
      {/* Final CTA */}
      <section className="w-full max-w-6xl mx-auto text-center my-20 px-6">
      ...
      {/* Footer */}
      <footer className="bg-[#EDEBFB] py-10 px-6 text-sm text-gray-600">
