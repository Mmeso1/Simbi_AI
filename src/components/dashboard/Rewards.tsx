  ...
  return (
    <section className="">
      <div className="flex mt-5 gap-x-7 gap-y-10 font-normal text-sm ">
        <aside className="bg-bluemaguerite hover:scale-105 duration-800 rounded-[20px] size-[160px] p-4 relative">
          <h3 className="">
        ...
        <aside className="bg-bluemaguerite hover:scale-105 duration-800 rounded-[20px] size-[160px] p-6 relative">
          <h3>Rewards Earned (token)</h3>
